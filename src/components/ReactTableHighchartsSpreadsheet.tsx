...
import './ReactTableHighchartsSpreadsheet.css';

interface ReactTableHighchartsSpreadsheetProps {
...
const ReactTableHighchartsSpreadsheet: React.FC<ReactTableHighchartsSpreadsheetProps> = ({ data, onDataChange }) => {
  ...
  React.useEffect(() => {
    if (!data || data.length === 0) {
      const defaultData: SpreadsheetData[] = [
        { '0': '150', '1': '120', '2': '180', '3': '95', '4': '200', '5': '160', '6': '140', '7': '110' },
        { '0': '180', '1': '140', '2': '220', '3': '110', '4': '250', '5': '190', '6': '170', '7': '130' },
        { '0': '120', '1': '90', '2': '150', '3': '75', '4': '160', '5': '125', '6': '110', '7': '85' },
        { '0': '200', '1': '160', '2': '240', '3': '130', '4': '280', '5': '210', '6': '190', '7': '150' },
        { '0': '160', '1': '130', '2': '190', '3': '100', '4': '220', '5': '170', '6': '150', '7': '120' },
        { '0': '140', '1': '110', '2': '170', '3': '85', '4': '190', '5': '145', '6': '130', '7': '100' },
        { '0': '220', '1': '180', '2': '260', '3': '150', '4': '300', '5': '230', '6': '210', '7': '170' },
        { '0': '100', '1': '80', '2': '130', '3': '65', '4': '140', '5': '105', '6': '95', '7': '75' },
        { '0': '190', '1': '150', '2': '230', '3': '120', '4': '260', '5': '200', '6': '180', '7': '140' },
        { '0': '130', '1': '100', '2': '160', '3': '80', '4': '180', '5': '135', '6': '120', '7': '90' },
        { '0': '170', '1': '140', '2': '200', '3': '110', '4': '240', '5': '180', '6': '160', '7': '125' },
        { '0': '110', '1': '85', '2': '140', '3': '70', '4': '150', '5': '115', '6': '100', '7': '80' },
      ];
  ...
  return (
    <div className="react-table-highcharts-spreadsheet">
      <div className="spreadsheet-header">
        <h3>📊 React Table + Highcharts</h3>
        <div className="spreadsheet-features">
          <span className="feature-badge">🔄 TanStack Pattern</span>
          ...
          <span className="feature-badge">📈 Highcharts Integration</span>
        </div>
      </div>
      ...
      <div className="spreadsheet-info">
        <h4>🎯 React Table + Highcharts Features</h4>
        <ul>
          ...
          <li><strong>Highcharts Integration:</strong> Real-time chart updates from table data</li>
          <li><strong>Professional Charts:</strong> Beautiful and responsive Highcharts</li>
        </ul>
      </div>
    </div>
  );
...
export default ReactTableHighchartsSpreadsheet; 